...
// Zeigt die Modul-Übersicht samt Studiengang/Fach-Filter und dem
// Vergleich zu klassischen Vorbereitungskursen. Wird sowohl auf der
// Startseite ("/") als auch unter "/dashboard" gerendert, damit neue
// Besucher:innen direkt die Module sehen, statt erst einen Fragebogen
    ...
    <div>
      ...
      <div className="card mb-8 p-5">
        ...
        {subject && (
          <button
            onClick={resetFilter}
            className="mt-5 block text-sm font-medium text-ink-500 underline"
          >
        ...
        <select
          ...
          className="mt-2 w-full max-w-xs rounded-lg border border-ink-200 bg-ink-50 px-4 py-2 text-sm text-ink-900 focus:border-brand-500 focus:outline-none sm:w-auto"
        >
