...
export const modules: ModuleDefinition[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      "Planung und Effectuation in jungen Unternehmen",
      "Vom MVP zum Pivot: Lean Startup und Design Thinking",
      "Organisation des Unternehmens",
      "Strategische Analyse: Markt, Wettbewerb und Ressourcen",
      "Strategische Optionen: Wachstum, Wettbewerb und Portfolio",
      "Corporate Governance",
      "Personalführung: Kontrolle, Anreize und Führungsverhalten",
      "Kundenverhalten verstehen: von Daten zu Erkenntnissen",
      "Kundenorientierte Produktgestaltung und Preispolitik",
      "Kommunikationspolitik: Werbewirkung messen und steuern",
  ...
  },
  {
    ...
    chapters: [
      ...
      "Buchungssystem: Der Worksheet Approach",
      ...
      "Der Betriebsabrechnungsbogen und Kostenverteilungsverfahren",
      "Investitionsrechnung II: Interner Zinssatz und Kapitalwertrate",
      "Kalkulationsverfahren der Kostenträgerstückrechnung",
