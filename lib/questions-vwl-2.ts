...
export const questions: Question[] = [
  ...
  },
  {
    ...
    unit: "Geldeinheiten",
    prompt:
      "Eine Volkswirtschaft produziert nur Fahrräder und Brot. Jahr 2020: Fahrradpreis 400, Brotpreis 1, 80 Fahrräder, 3.500 Brote. Wie hoch ist das nominale BIP im Jahr 2020?",
    correctValue: 35500,
    explanation:
      "Nominales BIP 2020 = 400·80 + 1·3.500 = 32.000 + 3.500 = 35.500.",
    source: "Übungsblatt 4, Aufgabe 2a",
    free: true,
  },
  {
    id: "bip-03",
    ...
    unit: "Geldeinheiten",
    prompt:
      "Dieselbe Volkswirtschaft (nur Fahrräder und Brot). Jahr 2030: Fahrradpreis 600, Brotpreis 2, 120 Fahrräder, 3.000 Brote. Wie hoch ist das nominale BIP im Jahr 2030?",
    correctValue: 78000,
    explanation:
      "Nominales BIP 2030 = 600·120 + 2·3.000 = 72.000 + 6.000 = 78.000.",
    source: "Übungsblatt 4, Aufgabe 2a",
    free: true,
  },
  {
    ...
    tolerance: 100,
    prompt:
      "Gleiche Volkswirtschaft: Jahr 2020 (Basisjahr): Fahrradpreis 400, Brotpreis 1. Jahr 2030-Mengen: 120 Fahrräder, 3.000 Brote. Wie hoch ist das reale BIP 2030, bewertet zu Preisen des Basisjahres 2020?",
    correctValue: 51000,
    explanation:
      "Reales BIP 2030 (Basis 2020) = 400·120 + 1·3.000 = 48.000 + 3.000 = 51.000 — die Mengen von 2030 werden zu den PREISEN von 2020 bewertet.",
    source: "Übungsblatt 4, Aufgabe 2b",
    free: true,
  },
  {
    id: "bip-05",
    topic: "BIP & VGR",
    type: "numeric",
    unit: "Indexpunkte (2020=100)",
    tolerance: 2,
    prompt:
      "Nominales BIP 2030 = 78.000, reales BIP 2030 zum Basisjahr 2020 = 51.000. Wie hoch ist der BIP-Deflator für 2030 (Basisjahr 2020 = 100)?",
    correctValue: 152.9,
    explanation:
      "BIP-Deflator = (Nominales BIP / Reales BIP) × 100 = (78.000 / 51.000) × 100 ≈ 152,9.",
  ...
  },
  {
    ...
    tolerance: 0.2,
    prompt:
      "Wachstumsbuchhaltung: Das BIP wächst um 4 %, der Kapitalstock um 6 %, die Arbeit um 2 %. Der Kapitalanteil am Einkommen beträgt α=0,3. Wie hoch ist die Wachstumsrate der totalen Faktorproduktivität (Solow-Residuum), gemäß ΔY/Y = ΔA/A + α·(ΔK/K) + (1−α)·(ΔL/L)?",
    correctValue: 0.8,
    explanation:
      "ΔA/A = ΔY/Y − α·ΔK/K − (1−α)·ΔL/L = 4 % − 0,3·6 % − 0,7·2 % = 4 − 1,8 − 1,4 = 0,8 %.",
  ...
  // ---------- Arbeitslosigkeit ----------
  {
    ...
    tolerance: 0.5,
    prompt:
      "Im Matching-Modell der natürlichen Arbeitslosenquote gilt (U/L)* = s/(s+f), wobei s die Job-Separation-Rate und f die Job-Finding-Rate ist. Bei s=0,04 und f=0,36: wie hoch ist die natürliche Arbeitslosenquote (in %)?",
    correctValue: 10,
    explanation: "(U/L)* = 0,04 / (0,04+0,36) = 0,04/0,40 = 0,10 = 10 %.",
  ...
  // ---------- Geld & Inflation ----------
  {
    ...
    tolerance: 0.5,
    prompt:
      "Laut Quantitätsgleichung M·V=P·Y wächst die Geldmenge M um 8 % pro Jahr, das reale BIP Y um 3 %, die Umlaufgeschwindigkeit V ist konstant. Wie hoch ist näherungsweise die Inflationsrate?",
    correctValue: 5,
    explanation: "π ≈ g_M − g_Y = 8 % − 3 % = 5 % (bei konstanter Umlaufgeschwindigkeit V).",
  ...
  },
  {
    ...
    tolerance: 0.2,
    prompt:
      "Der Nominalzins beträgt 6 %, die erwartete Inflation 4 %. Wie hoch ist der Realzins gemäß der (näherungsweisen) Fisher-Gleichung i = r + π^e?",
    correctValue: 2,
    explanation: "r = i − π^e = 6 % − 4 % = 2 %.",
  ...
  // ---------- Konjunktur I ----------
  {
    ...
    unit: "Mrd. €",
    prompt:
      "Im keynesianischen Kreuz mit marginaler Konsumquote γ=0,75 erhöht der Staat die Ausgaben um 10 Mrd. €. Um wie viel steigt das Gleichgewichtseinkommen (ΔY = ΔG/(1−γ))?",
    correctValue: 40,
    explanation: "ΔY = ΔG/(1−γ) = 10/(1−0,75) = 10/0,25 = 40 Mrd. €.",
  ...
  },
  {
    ...
    unit: "Mrd. €",
    prompt:
      "Im selben Modell (γ=0,75) senkt der Staat stattdessen die Steuern um 10 Mrd. €. Um wie viel steigt das Gleichgewichtseinkommen (ΔY = γ/(1−γ)·|ΔT|)?",
    correctValue: 30,
    explanation: "ΔY = γ/(1−γ)·ΔT = 0,75/0,25·10 = 30 Mrd. € — kleiner als bei der Ausgabenerhöhung, da ein Teil der Steuersenkung gespart statt konsumiert wird.",
