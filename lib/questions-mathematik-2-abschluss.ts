...
export const questions: Question[] = [
  ...
  },
  {
    ...
    topic: "Ober- und Untersummen: das Riemann-Integral im Rⁿ",
    type: "numeric",
    prompt: "Bestimmen Sie das Riemann-Integral von f(x,y) := xy über [0,1]² als Grenzwert von Ober- und Untersummen.",
    correctValue: 0.25,
    explanation: "Für die Partition in 2ⁿ×2ⁿ gleich große Quadrate konvergieren Ober- und Untersumme gegen ∫₀¹∫₀¹ xy dx dy = (1/2)·(1/2) = 1/4.",
  ...
  // ---------- Eigenschaften des Jordan-Inhalts und der Satz von Fubini ----------
  {
    ...
    type: "numeric",
    prompt: "Gegeben sei M := [0,2] × [1,3]. Berechnen Sie ∫_M x/y² d(x,y).",
    correctValue: 1.333,
    tolerance: 0.01,
    explanation: "Mit Fubini gilt ∫_M x/y² d(x,y) = (∫₀² x dx)·(∫₁³ y⁻² dy) = 2 · (1 − 1/3) = 2 · 2/3 = 4/3 ≈ 1,333.",
  ...
  },
  {
    ...
    topic: "Eigenschaften des Jordan-Inhalts und der Satz von Fubini",
    type: "numeric",
    prompt: "Gegeben sei M := [0,2] × [0,1] × [0, log(3)]. Berechnen Sie ∫_M (x + 2y)·eᶻ d(x,y,z).",
    correctValue: 8,
    explanation:
      "Mit Fubini: ∫₀² (x+2y) dx = 2+4y, also ∫₀¹ (2+4y) dy = [2y+2y²]₀¹ = 4. Der z-Faktor ist [eᶻ]₀^{log 3} = 3−1 = 2. Insgesamt 4·2 = 8.",
    source: "Kapitel 5, Satz von Fubini (nach Klausur SS2024 Nachtermin)",
    free: false,
  },
  {
    id: "fu-03",
