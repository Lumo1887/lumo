...
// Algebra: LGS, Vektorräume, lineare Abbildungen, Skalarprodukte; Analysis:
...
export const chapters: SkriptChapter[] = [
  ...
  // ==================== Kapitel 3 ====================
  {
    ...
    sections: [
      {
        id: "3-1",
        heading: "3.1 Häufungspunkte und Funktionsgrenzwerte",
        body: [
      ...
      {
        id: "3-2",
        heading: "3.2 Stetigkeit und die ε-δ-Charakterisierung",
        body: [
      ...
      {
        id: "3-3",
        heading: "3.3 Zwischenwertsatz, Extrema stetiger Funktionen und Umkehrfunktionen",
        body: [
  ...
  // ==================== Kapitel 4 ====================
  {
    ...
    sections: [
      {
        id: "4-1",
        heading: "4.1 Die allgemeine Exponential- und Logarithmusfunktion",
        body: [
      ...
      {
        id: "4-2",
        heading: "4.2 Wachstumsvergleich zwischen Potenz-, Exponential- und Logarithmusfunktionen",
        body: [
  ...
  // ==================== Kapitel 5 ====================
  {
    ...
    sections: [
      {
        id: "5-1",
        heading: "5.1 Lineare Abbildungen, Kern und Bild",
        body: [
      ...
      {
        id: "5-2",
        heading: "5.2 Matrixdarstellung, Matrizenmultiplikation und Isomorphismen",
        body: [
      ...
      {
        id: "5-3",
        heading: "5.3 Reguläre Matrizen und die Inverse",
        body: [
        ...
        examples: [
          "Für C=[[2,1,1],[1,1,1],[1,1,2]] (det(C)=1≠0, also regulär) liefert der Gauß-Algorithmus angewendet auf (C|E) die Inverse C⁻¹=[[1,−1,0],[−1,3,−1],[0,−1,1]]. Probe (erste Zeile von C mal erste Spalte von C⁻¹): 2·1+1·(−1)+1·0=1 ✓ (Diagonaleintrag der Einheitsmatrix).",
        ],
      },
    ],
  },
  // ==================== Kapitel 6 ====================
  {
    ...
    sections: [
      {
        id: "6-1",
        heading: "6.1 Die Ableitung und Differenzierbarkeit",
        body: [
      ...
      {
        id: "6-2",
        heading: "6.2 Ableitungsregeln: Produkt-, Quotienten- und Kettenregel",
        body: [
      ...
      {
        id: "6-3",
        heading: "6.3 Ableitung der Umkehrfunktion und elementare Ableitungen",
        body: [
          "Ist f in x0 differenzierbar mit f'(x0)≠0 und besitzt f eine Umkehrfunktion f⁻¹, die in y0:=f(x0) stetig ist, so ist f⁻¹ in y0 differenzierbar mit (f⁻¹)'(y0) = 1/f'(x0) = 1/f'(f⁻¹(y0)). Damit lassen sich die Ableitungen von Umkehrfunktionen elementarer Funktionen bestimmen: Aus (e^x)'=e^x folgt (ln x)'=1/x; aus (tan x)'=1/cos²x folgt (arctan x)'=1/(1+x²); analog ergeben sich die Ableitungen von arcsin und arccos.",
        ...
        examples: [
          "Mit (arctan x)'=1/(1+x²) ergibt sich die Steigung des Graphen von arctan im Punkt x=1: (arctan)'(1) = 1/(1+1²) = 1/2.",
        ],
      },
    ],
  },
  // ==================== Kapitel 7 ====================
  {
    ...
    sections: [
      {
        id: "7-1",
        heading: "7.1 Lokale und globale Extrema",
        body: [
      ...
      {
        id: "7-2",
        heading: "7.2 Der Satz von Rolle und der Mittelwertsatz",
        body: [
      ...
      {
        id: "7-3",
        heading: "7.3 Konvexität, Wendepunkte und Kurvendiskussion",
        body: [
        ...
        examples: [
          "Kurvendiskussion von f(x)=x³−3x: Nullstellen bei x=0 und x=±√3 (aus x³−3x=x(x²−3)=0). Aus 7.1: lokales Maximum bei x=−1 (Wert 2), lokales Minimum bei x=1 (Wert −2). Die zweite Ableitung f''(x)=6x wechselt bei x=0 das Vorzeichen (negativ für x<0, positiv für x>0), also ist x0=0 ein Wendepunkt mit f(0)=0. Da f ungerade ist (f(−x)=−f(x)), ist der Graph punktsymmetrisch zum Ursprung — insgesamt ergibt sich ein s-förmiger Verlauf mit Maximum bei (−1,2), Wendepunkt bei (0,0) und Minimum bei (1,−2).",
        ],
      },
    ],
  },
  // ==================== Kapitel 8 ====================
  {
    ...
    sections: [
      {
        id: "8-1",
        heading: "8.1 Die Regel von de l'Hospital",
        body: [
      ...
      {
        id: "8-2",
        heading: "8.2 Der Satz von Taylor und Taylorpolynome",
        body: [
  ...
  // ==================== Kapitel 9 ====================
  {
    ...
    free: false,
    intro:
      "Skalarprodukte erlauben es, Längen, Winkel und Orthogonalität in beliebigen Vektorräumen zu definieren — nicht nur im vertrauten ℝⁿ. Dieses Kapitel behandelt die grundlegenden Ungleichungen, das Gram-Schmidt-Verfahren und Abstandsberechnungen.",
    sections: [
      {
        id: "9-1",
        heading: "9.1 Skalarprodukte, Norm und die Cauchy-Schwarz-Ungleichung",
        body: [
      ...
      {
        id: "9-2",
        heading: "9.2 Orthogonalität und das Gram-Schmidt-Verfahren",
        body: [
      ...
      {
        id: "9-3",
        heading: "9.3 Orthogonale Projektion und Abstandsaufgaben im Rⁿ",
        body: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Ein uneigentliches Integral liegt vor, wenn entweder das Integrationsintervall unbeschränkt ist (z. B. ∫_a^∞ f(x)dx := lim_{t→∞} ∫_a^t f(x)dx) oder der Integrand am Rand unbeschränkt ist. Ein uneigentliches Integral heißt konvergent, wenn der entsprechende Grenzwert existiert (und endlich ist), andernfalls divergent. Majoranten- und Minorantenkriterium erlauben Konvergenzaussagen durch Vergleich mit einer bekannten Funktion, ohne das Integral explizit zu berechnen — ein Standardbeispiel ist die Gammafunktion Γ(x):=∫_0^∞ t^(x−1)e^(−t)dt, definiert über ein für x>0 konvergentes uneigentliches Integral.",
        ],
        formulas: [
        ...
        examples: [
          "Partielle Integration: ∫_0^1 x·e^x dx = [x·e^x]_0^1 − ∫_0^1 e^x dx = (1·e^1−0) − [e^x]_0^1 = e − (e−1) = 1. — Uneigentliches Integral: ∫_1^∞ 1/x² dx = lim_{t→∞}[−1/x]_1^t = lim_{t→∞}(−1/t+1) = 1 (konvergent), während ∫_1^∞ 1/x dx = lim_{t→∞}[ln x]_1^t = lim_{t→∞} ln(t) = ∞ divergiert — ein klassischer Kontrast zwischen 1/x² und 1/x im uneigentlichen Integral.",
        ],
      },
    ],
  },
