...
export const questions: Question[] = [
  ...
  },
  {
    ...
    unit: "Tickets",
    prompt:
      "Für ein ausverkauftes Konzert gibt es einen Zweitmarkt für Tickets mit sehr vielen Nachfragern und Nachfragefunktion D(p) = max{0, 420 − p}. Wie viele Tickets werden bei einem Preis von p = 170 nachgefragt?",
    correctValue: 250,
    explanation: "D(170) = 420 − 170 = 250.",
    source: "Angepasst nach Übungsblatt 1 (Wohnungsmarkt-Aufgabe), Szenario und Zahlen geändert",
    free: true,
  },
  {
    ...
    topic: "Markt und Budgetmenge",
    type: "numeric",
    unit: "Balsaholz-Platten",
    prompt:
      "Ein Hobby-Modellbauer kauft für seine Bastelprojekte ausschließlich Balsaholz-Platten (Gut 1, Preis 4 GE/Platte) und Sekundenkleber (Gut 2, Preis 6 GE/Tube) bei einem monatlichen Budget von 120 GE. Wie viele Balsaholz-Platten kann er sich maximal leisten, wenn er sein gesamtes Budget nur dafür ausgibt?",
    correctValue: 30,
    explanation: "Maximal leistbare Menge von Gut 1: m/p1 = 120/4 = 30 Platten.",
  ...
  // ---------- Technologie und Gewinnmaximierung ----------
  {
    ...
    unit: "kg Ton",
    prompt:
      "Eine Töpferei nutzt Ton als einzigen variablen Input für ihre Werkstatt, der 1 GE pro Kilogramm kostet. x kg Ton erlauben eine Produktion von y = 10√x fertigen Gefäßen. Der Preis pro Gefäß ist 4 GE. Wie viele Kilogramm Ton setzt die Töpferei gewinnmaximal ein?",
    correctValue: 400,
    explanation:
      "Gewinn π(x) = 4·10√x − 1x = 40√x − x. F.O.C.: 20/√x = 1 ⟹ √x = 20 ⟹ x* = 400.",
  ...
  },
  {
    ...
    unit: "Gefäße",
    prompt:
      "Bei gewinnmaximalem Toneinsatz von x = 400 kg produziert die Töpferei y = 10√x Gefäße. Wie viele sind das?",
    correctValue: 200,
    explanation: "y = 10·√400 = 10·20 = 200.",
    source: "Angepasst nach Übungsblatt 8, Aufgabe 3, Szenario und Zahlen geändert",
    free: false,
  },
  {
  ...
  // ---------- Präferenzen und Nutzen ----------
  {
    ...
    type: "mc",
    prompt:
      "Ein dreiköpfiges Auswahlkomitee (Person 1, 2, 3) muss sich per Mehrheitsentscheidung zwischen drei Bewerbern für eine offene Stelle entscheiden: X, Y oder Z. Die individuellen Präferenzen sind: Person 1: X≻Y≻Z, Person 2: Y≻Z≻X, Person 3: Z≻X≻Y. Wird paarweise zwischen je zwei Bewerbern abgestimmt, welche Eigenschaft hat die resultierende Gruppenpräferenz ≿maj?",
    options: [
      "Sie ist NICHT transitiv (Condorcet-Zyklus: X≻majY≻majZ≻majX)",
      "Sie ist transitiv und vollständig, exakt wie jede Einzelpräferenz",
      "Sie ist identisch mit der Präferenz von Person 1",
      "Es gibt einen eindeutigen, unbestrittenen Gewinnerbewerber",
    ],
    correctIndex: 0,
    explanation:
      "Zwei von drei bevorzugen X vor Y (Person 1, 3), zwei von drei bevorzugen Y vor Z (Person 1, 2), zwei von drei bevorzugen Z vor X (Person 2, 3) — die Mehrheitsrelation ist zyklisch und damit intransitiv, obwohl jede Einzelperson rationale (transitive) Präferenzen hat.",
  ...
  },
  {
    ...
    type: "mc",
    prompt:
      "Seien u1(x1,x2)=x1²x2, u2(x1,x2)=x1⁴x2² und u3(x1,x2)=2ln x1 + ln x2 drei Nutzenfunktionen. Welche Aussage trifft zu?",
    options: [
  ...
  },
  {
    ...
    source: "Angepasst nach Übungsblatt 9, Aufgabe 8, Zahlen geändert",
    free: false,
  },
  ...
  },
  {
    ...
    type: "mc",
    prompt:
      "Für die Nutzenfunktionen u(x1,x2)=2x1+x2 (perfekte Substitute), u(x1,x2)=4ln x1+ln x2 (Cobb-Douglas) und u(x1,x2)=min{x1,2x2} (Leontief): Was fällt auf, wenn man die Einkommensexpansionspfade vergleicht?",
    options: [
    ...
    correctIndex: 0,
    explanation:
      "Bei perfekten Substituten liegt der Expansionspfad (meist) auf einer Achse (Randlösung, abhängig vom Preisverhältnis), bei Cobb-Douglas ist er ein Strahl mit konstanten Ausgabenanteilen, bei Leontief ein Strahl mit fixem Mengenverhältnis (hier x1=2x2) — die zugrundeliegende Substituierbarkeit der Präferenzen bestimmt die Form.",
  ...
  },
  {
    ...
    topic: "Bekundete Präferenzen und Slutsky-Zerlegung",
    type: "numeric",
    unit: "Kubikmeter Fräsholz",
    prompt:
      "Eine Tischlerei bezieht Fräsholz für die Möbelproduktion. Ihre Nachfragefunktion lautet x1 = m/50 − 2p1, wobei m das monatliche Materialbudget in GE ist. Bei einem Budget von 3000 GE und einem Preis von 15 GE pro Kubikmeter, wie viele Kubikmeter kauft die Tischlerei?",
    correctValue: 30,
    explanation: "x1 = 3000/50 − 2·15 = 60 − 30 = 30.",
    source: "Angepasst nach Übungsblatt 5 (Slutsky-Zerlegung), Aufgabe 1a, Szenario und Zahlen geändert",
    free: false,
  },
  {
    id: "bs-03",
    ...
    unit: "Kubikmeter Fräsholz",
    prompt:
      "Für die Tischlerei (x1 = m/50 − 2p1, m=3000) steigt der Preis pro Kubikmeter Fräsholz von 15 auf 18 GE. Wie viele Kubikmeter kauft sie bei unverändertem Budget jetzt?",
    correctValue: 24,
    explanation: "x1 = 3000/50 − 2·18 = 60 − 36 = 24.",
    source: "Angepasst nach Übungsblatt 5 (Slutsky-Zerlegung), Aufgabe 1b, Szenario und Zahlen geändert",
    free: false,
  },
  {
    id: "bs-04",
  ...
  // ---------- Angebot der Unternehmung und Marktangebot der Branche ----------
  {
    ...
    type: "mc",
    prompt:
      "Eine Firma unter vollständiger Konkurrenz hat die Kostenfunktion C(y) = 5y² + 3y + F für y>0 und C(0)=0 (F sind Quasi-Fixkosten). Bei welchem Preis p produziert die Firma gerade noch eine positive Menge (Stilllegungsgrenze)?",
    options: [
