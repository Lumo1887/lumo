...
function Boxplot() {
  return (
    <>
      ...
      <Text x={30} y={135} fontSize={15} fill={INK} fontFamily={FONT}>Min</Text>
      <Text x={55} y={30} fontSize={15} fill={BRAND} fontFamily={FONT}>Q1</Text>
      <Text x={95} y={135} fontSize={15} fill={BRAND} fontFamily={FONT}>Median</Text>
      <Text x={160} y={30} fontSize={15} fill={BRAND} fontFamily={FONT}>Q3</Text>
      <Text x={312} y={135} fontSize={15} fill={INK} fontFamily={FONT}>Max</Text>
      <Text x={345} y={60} fontSize={13} fill={INK} fontFamily={FONT}>Ausreißer</Text>
    </>
  );
}
...
function Histogram() {
  ...
  return (
    <>
      ...
      <Text x={140} y={188} fontSize={15} fill={INK} fontFamily={FONT}>Klassen (x)</Text>
      <Text x={6} y={20} fontSize={13} fill={INK} fontFamily={FONT}>Häufigkeitsdichte</Text>
    </>
  );
}
...
function Lorenz() {
  return (
    <>
      ...
      <Text x={20} y={14} fontSize={11} fill={INK} fontFamily={FONT}>Einkommensanteil</Text>
      <Text x={35} y={240} fontSize={12} fill={INK} fontFamily={FONT}>Bevölkerungsanteil</Text>
      <Text x={150} y={70} fontSize={14} fill={BRAND} fontFamily={FONT}>Lorenzkurve</Text>
      <Text x={140} y={130} fontSize={12} fill={INK} fontFamily={FONT}>Gleichverteilung</Text>
    </>
  );
}
...
function Venn() {
  return (
    <>
      ...
      <Text x={90} y={60} fontSize={20} fill={BRAND} fontFamily={FONT}>A</Text>
      <Text x={225} y={60} fontSize={20} fill="#b45309" fontFamily={FONT}>B</Text>
      <Text x={150} y={105} fontSize={15} fill={INK} fontFamily={FONT}>A∩B</Text>
      <Text x={185} y={175} fontSize={12} fill={INK} fontFamily={FONT}>Schnittmenge</Text>
    </>
  );
}
...
function Tree() {
  return (
    <>
      ...
      <Text x={90} y={70} fontSize={15} fill={BRAND} fontFamily={FONT}>P(B₁)</Text>
      <Text x={90} y={150} fontSize={15} fill={BRAND} fontFamily={FONT}>P(B₂)</Text>
      ...
      <Text x={220} y={30} fontSize={13} fill={INK} fontFamily={FONT}>P(A|B₁)</Text>
      <Text x={218} y={95} fontSize={13} fill={INK} fontFamily={FONT}>P(Ā|B₁)</Text>
      <Text x={220} y={140} fontSize={13} fill={INK} fontFamily={FONT}>P(A|B₂)</Text>
      <Text x={218} y={215} fontSize={13} fill={INK} fontFamily={FONT}>P(Ā|B₂)</Text>
    </>
  );
}
...
function DistributionFunction() {
  ...
  return (
    <>
      ...
      <Text x={325} y={20} fontSize={13} fill={INK} fontFamily={FONT}>1</Text>
      <Text x={175} y={195} fontSize={15} fill={INK} fontFamily={FONT}>x</Text>
      <Text x={4} y={20} fontSize={15} fill={INK} fontFamily={FONT}>F(x)</Text>
    </>
  );
}
...
function NormalCurve() {
  return (
    <>
      ...
      <Text x={178} y={170} fontSize={16} fill={INK} fontFamily={FONT}>μ</Text>
      <Text x={218} y={70} fontSize={14} fill={BRAND} fontFamily={FONT}>σ = Streuung</Text>
    </>
  );
}
...
function BinomialBars() {
  ...
  return (
    <>
      ...
      <Text x={155} y={162} fontSize={14} fill={INK} fontFamily={FONT}>Anzahl Erfolge k</Text>
    </>
  );
}
